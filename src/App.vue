<template>
  <div id="app">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Go back on top</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about breeds">About breeds</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#our dogs">Our Dogs</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#about breeds">Tell Me More</a>
        </div>
      </div>
    </header>

    <!-- Services -->
    <section id="about breeds">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">About breeds</h2>
...
The Maine Coon was denied provisional breed status—one of the three steps required for a breed not yet recognized by the CFA to be able to compete in championship competitions[11]—by the CFA three times, which led to the formation of the Maine Coon Cat Club in 1973. The breed was finally accepted by the CFA under provisional status on 1 May 1975, and was approved for championship status on 1 May 1976. The next couple of decades saw a rise in popularity of the Maine Coon, with championship victories and an increase in national rankings. In 1985, the state of Maine announced that the breed would be named the official state cat. Today the Maine Coon is the third most popular cat breed, according to the number of kittens registered with the CFA.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">The best way to choose a puppy is to play with him.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Kennel Galaktic Gravity</span>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
